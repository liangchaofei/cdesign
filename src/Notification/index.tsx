...
const cfNotification = (function() {
  ...
  const pop = (config: any) => {
    ...
    notification.notice({
      content: (
        <div className={classnames('cfNotice', className)}>
          {(icon ||
          ...
          <div>
            <div className="cfNoticeTit">{message}</div>
            <div className="cfNoticeDesc">{description}</div>
          </div>
        </div>
      ),
      key,
  ...
  const config = (config: any) => {
    ...
    Notification.newInstance(
      ...
      (notice: any) => (notification = notice),
    );
  };
